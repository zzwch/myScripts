...
write.table(umimat, file = file.path(summary_dir, "stat_quantify.umi.xls"), sep = "\t", row.names = F)
write.table(readmat, file = file.path(summary_dir, "stat_quantify.read.xls"), sep = "\t", row.names = F)
write.table(mapmat, file = file.path(summary_dir, "stat_quantify.mapflag.xls"), sep = "\t", row.names = F)